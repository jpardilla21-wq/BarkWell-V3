...
router.post('/', async (req, res) => {
  try {
    const { userId, name, breed, dateOfBirth, gender, weightUnit, photoUrl } = req.body;
    ...
    const result = await db.query(
      `INSERT INTO pets (user_id, name, breed, date_of_birth, gender, weight_unit, photo_url)
       ...
       RETURNING *`,
      [userId, name, breed || null, dateOfBirth || null, gender || 'unknown', weightUnit || 'lbs', photoUrl || null]
    );
