...
app.listen(PORT, async () => {
  ...
  console.log("");
  console.log(
    "GET    /api/health-records/vaccinations/:petId      - Get vaccinations",
  );
  console.log(
  ...
  console.log("");
  console.log(
    "GET    /api/health-records/medications/:petId       - Get medications",
  );
  console.log(
  ...
  console.log("");
  console.log(
    "GET    /api/health-records/vet-visits/:petId        - Get vet visits",
  );
  console.log(
  ...
  console.log("");
  console.log(
    "GET    /api/daily-logs/:petId                       - Get daily logs",
  );
  console.log(
    "GET    /api/daily-logs/:petId/wellness-trend        - Get wellness trend",
  );
  console.log(
    "GET    /api/daily-logs/:petId/current-score         - Get current score",
  );
  console.log(
  ...
  console.log("");
  console.log(
    "GET    /api/weight-logs/:petId                      - Get weight logs",
  );
  console.log(
    "GET    /api/weight-logs/:petId/trend                - Get weight trend",
  );
  console.log(
    "GET    /api/weight-logs/:petId/latest               - Get latest weight",
  );
  console.log(
  ...
  console.log(
    "GET    /api/nutrition/treats/:petId                 - Get treat logs",
  );
  console.log(
    "POST   /api/nutrition/treats                        - Log treat",
  );
  console.log(
    "DELETE /api/nutrition/treats/:id                    - Delete treat",
  );
  console.log("");
  console.log(
  ...
  console.log(
    "GET    /api/content/categories/list                 - Get content categories",
  );
  console.log("");
  console.log(
  ...
  console.log(
    "GET    /api/breeds/:breedName                       - Get breed information",
  );
  console.log("");
  console.log("--- Phase 3: Monetization Features ---");
  console.log(
    "GET    /api/subscriptions/tiers                     - Get subscription tiers & pricing",
  );
  console.log(
    "GET    /api/subscriptions/status/:userId            - Get user subscription status",
  );
  console.log(
    "POST   /api/subscriptions/subscribe                 - Subscribe to premium (mock payment)",
  );
  console.log(
  ...
  console.log("");
  console.log(
    "GET    /api/shop/products                           - Get affiliate products",
  );
  console.log(
    "GET    /api/shop/curated/:petId                     - Get personalized product recommendations",
  );
  console.log(
  ...
  console.log(
    "POST   /api/shop/track-click                        - Track affiliate click",
  );
  console.log("");
});
