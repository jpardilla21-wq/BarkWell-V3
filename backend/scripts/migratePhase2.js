...
async function migratePhase2() {
  try {
    ...
    console.log('✓ Tables added: nutrition_plans, food_database, treat_logs, content_library, breed_info');
    console.log('✓ Mock data inserted for food_database, content_library, and breed_info');
